...
const fields = [
  ...
  },
  {
    ...
    placeholder: '例如：12小时保温、316不锈钢内胆、智能温控显示、颜值高',
  },
  {
    name: 'platform',
    label: '目标平台',
  ...
  },
  {
    ...
    type: 'select' as const,
    options: [
      { label: '活泼种草风', value: '活泼种草风' },
      { label: '专业权威风', value: '专业权威风' },
      { label: '情感共鸣风', value: '情感共鸣风' },
      { label: '简洁直接风', value: '简洁直接风' },
      { label: '高端奢华风', value: '高端奢华风' },
    ],
  },
];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <section className="relative overflow-hidden pt-28 pb-10 sm:pt-32 sm:pb-12">
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-gradient-to-br from-purple-100/60 via-purple-50/40 to-transparent rounded-full blur-3xl" />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-4 animate-fade-in">
            <Link to="/workspace" className="hover:text-purple-600 transition-colors">
              工具
            </Link>
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
            </svg>
            <span className="text-gray-900 dark:text-white font-medium">文案生成器</span>
          </div>
      ...
      <section className="pb-20 sm:pb-28">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PlanGenerator
            title="AI 文案生成器"
            description="输入产品信息，AI 批量生成多种风格营销文案"
            accentColor="purple"
            systemPrompt="你是一个顶尖的营销文案专家。请根据用户提供的商品信息，批量生成多种风格的营销文案。请生成以下内容：## 🔥 吸睛标题（生成8-10个不同风格的标题，编号列出）\n## ✨ 广告语/Slogan（生成5-6条简短有力的广告语）\n## 📝 卖点文案（将核心卖点转化为消费者语言，每个卖点一段）\n## 📖 详情页描述（300-500字的商品详情页长文案）\n## 💬 社交媒体文案（适配不同平台风格的短文案：小红书风/抖音风/朋友圈风）\n请用Markdown格式输出，文案吸引眼球、有转化力。"
            fields={fields}
          />
        </div>
      </section>
