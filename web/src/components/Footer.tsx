        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/workspace" className="text-sm text-gray-400 hover:text-white transition-colors">
                  AI工作台
                </Link>
              </li>
              <li>
          ...
          {/* Features */}
          <div>
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-4">功能</h3>
            <ul className="space-y-3">
              <li>
                <span className="text-sm text-gray-400">智能改写</span>
              </li>
              <li>
                <span className="text-sm text-gray-400">一键扩写</span>
              </li>
              <li>
                <span className="text-sm text-gray-400">多语言翻译</span>
              </li>
              <li>
                <span className="text-sm text-gray-400">内容总结</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <span className="text-sm text-gray-400">帮助中心</span>
              </li>
              <li>
