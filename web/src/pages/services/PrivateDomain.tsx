...
const RELATED = [
  { to: '/services/group-buy', label: '团购运营' },
  { to: '/services/ai-cs', label: 'AI客服' },
];
...
const fields = [
  ...
  },
  {
    ...
    options: [
      { label: '0-100人', value: '0-100人' },
      { label: '100-1000人', value: '100-1000人' },
      { label: '1000-1万人', value: '1000-1万人' },
  ...
  },
  {
    ...
    placeholder: '例如：3个月内私域用户从500增长到5000，复购率提升到30%',
  },
];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <section className="relative overflow-hidden pt-28 pb-10 sm:pt-32 sm:pb-12">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-4 animate-fade-in">
            ...
            <span className="text-gray-900 dark:text-white font-medium">私域搭建</span>
          </div>
      ...
      <section className="pb-20 sm:pb-28">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PlanGenerator
            title="AI 私域运营SOP生成器"
            description="输入业务信息，AI 自动生成私域运营标准流程"
            accentColor="purple"
            systemPrompt="你是一个私域运营专家。请根据用户提供的业务信息，生成一份完整的私域运营SOP方案。方案必须包含：## 🏗️ 社群搭建方案（社群定位、入群门槛、群规设计、欢迎语）\n## 👥 用户分层策略（RFM模型分层、各层级运营策略、标签体系设计）\n## 🤖 自动化营销（自动欢迎语、标签触发规则、定时群发计划、智能回复模板）\n## 🚀 裂变增长方案（裂变活动设计、邀请奖励机制、分销体系）\n## 📅 每日运营SOP（按时间线列出每日运营动作清单）\n请用Markdown格式输出，方案具体可执行。"
            fields={fields}
          />
        </div>
      </section>
