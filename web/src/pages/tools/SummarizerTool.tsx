...
const fields = [
  ...
  },
  {
    ...
    options: [
      { label: '核心要点', value: '核心要点' },
      { label: '段落摘要', value: '段落摘要' },
      { label: '一句话总结', value: '一句话总结' },
      { label: '结构化摘要', value: '结构化摘要' },
    ],
  },
  {
    name: 'length',
    ...
    type: 'select' as const,
    options: [
      { label: '简洁（100字以内）', value: '简洁' },
      { label: '标准（200字左右）', value: '标准' },
      { label: '详细（500字左右）', value: '详细' },
    ],
  },
];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <section className="relative overflow-hidden pt-28 pb-10 sm:pt-32 sm:pb-12">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-4 animate-fade-in">
            ...
            <span className="text-gray-900 dark:text-white font-medium">文本摘要</span>
          </div>
      ...
      <section className="pb-20 sm:pb-28">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <PlanGenerator
            title="AI 高级文本摘要"
            description="粘贴长文，AI 快速提炼核心要点"
            accentColor="amber"
            systemPrompt="你是一个专业的文本摘要专家。请根据用户选择的摘要模式生成摘要。\n\n## 核心要点模式\n提取文章的3-5个核心要点，每个要点用一句话概括。\n\n## 段落摘要模式\n生成一段200字左右的连贯摘要，覆盖文章的主要内容。\n\n## 一句话总结模式\n用一句话（不超过50字）精准概括文章的核心内容。\n\n## 结构化摘要模式\n按以下结构输出：\n- 📌 核心主题\n- 🔑 关键要点（3-5个）\n- 📊 数据/事实（如有）\n- 💡 结论/建议\n\n请严格按照所选模式输出，不要添加多余内容。"
            fields={fields}
          />
        </div>
      </section>
