        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-3">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <span className="text-sm font-semibold text-gray-900 dark:text-white">{genreConfig.label}</span>
                <span className="text-xs text-gray-500 dark:text-gray-400 ml-2">
                  场景 {gameState.sceneCount}/{gameState.maxScenes}
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={handleExport} className="p-2 rounded-lg text-gray-500 hover:text-violet-600 dark:text-gray-400 dark:hover:text-violet-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors" title="导出故事">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
