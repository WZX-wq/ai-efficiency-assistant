import{j as e,m as r,A as c}from"./vendor-motion-CImYs8Me.js";import{a as s}from"./vendor-react-DfmVI5gG.js";const v="ai-assistant-feedbacks",j="ai-assistant-feedback-given",C=["功能建议","Bug反馈","体验优化","内容质量","其他"],E=["😞","😐","🙂","😊","🤩"],w=["很差","较差","一般","满意","非常满意"];function L(){try{const a=localStorage.getItem(v);return a?JSON.parse(a):[]}catch{return[]}}function F(a){localStorage.setItem(v,JSON.stringify(a))}function A(){return sessionStorage.getItem(j)==="true"}function D(){sessionStorage.setItem(j,"true")}function T({rating:a,onChange:i}){return e.jsx("div",{className:"flex items-center justify-center gap-1",children:E.map((m,o)=>{const n=o+1;return e.jsxs(r.button,{type:"button",whileHover:{scale:1.25},whileTap:{scale:.9},onClick:()=>i(n),className:`
